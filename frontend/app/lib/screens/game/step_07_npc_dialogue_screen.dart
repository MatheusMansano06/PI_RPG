...
import 'step_08_stage_challenge_screen.dart';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          GameButton(
                            ...
                            compact: compact,
                            onPressed: () {
                              // Vai para a tela 08, que tem a pergunta da fase.
          ...
          Center(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                // Fundo simples atras da imagem do personagem.
...
({String imagePath, String role, Color color}) _npcPersona(String npcName) {
  ...
  // Seu Ze tem acento no roteiro, entao testamos as duas formas.
  if (lower.contains('zé') || lower.contains('ze')) {
    return (
